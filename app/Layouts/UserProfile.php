...
?>
        <form id="signup-form" class="w-100 align-items-center" method="post" action="signUp_logic.php">
            <div class="form-floating mb-3 w-75 mx-auto">
                <input name="username" class="form-control focus-ring focus-ring-info" type="text" placeholder="Username" aria-label="Username" required>
                <label for="floatingInput">Username</label>     
            </div>

            <div class="form-floating mb-3 w-75 mx-auto">
                <input name="email" class="form-control  focus-ring focus-ring-info" type="email" placeholder="Email" aria-label="Email" required>
